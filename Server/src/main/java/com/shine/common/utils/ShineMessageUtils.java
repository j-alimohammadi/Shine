 ...
 */
@Component("shineMessageUtils")
public final class ShineMessageUtils implements ApplicationContextAware {
    ...
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        ShineMessageUtils.applicationContext = applicationContext;
    }
}
